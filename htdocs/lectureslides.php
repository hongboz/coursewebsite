...
<html>
<head>
<title>A2 Lecture Slides</title>

<!--inherit from course labs css page style-->
<link rel="stylesheet" type="text/css" href="courselabs.css">
<link rel="stylesheet" type="text/css" href="lectureslides.css"> 
...
<p id=text class=para>You can find all lecture slides here, corresponding to the week number.</p>
