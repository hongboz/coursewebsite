...
<!--Add buttons here-->
<a href="syllabus.php"><button class=button1> Course Syllabus </button></a>
<a href="lectureslides.php"><button class=button1> Weekly Lecture Slides </button></a>
<a href="assignments.php"><button class=button1> Assignments </button></a>
<a href="practicequizzes.php"><button class=button1> Practice Quizzes </button></a>
<a href="courselabs.php"><button class=button1> Course Labs </button></a>
<a href="schedule.php"><button class=button1> Schedule </button></a>
</div>
</div>
